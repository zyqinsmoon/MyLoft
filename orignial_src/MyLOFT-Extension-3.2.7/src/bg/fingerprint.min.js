...
var FingerprintJS = (function (e) {
            ...
            t(this, void 0, void 0, function () {
                ...
                return r(this, function (r) {
                    switch (r.label) {
                        ...
                        case 1:
                            return i < e.length ? (n(e[i], i), (c = Date.now()) >= t + o ? ((t = c), [4, a(0)]) : [3, 3]) : [3, 4];
                        case 2:
                            r.sent(), (r.label = 3);
                        case 3:
                            return ++i, [3, 1];
    ...
    function p(e, n) {
        ...
        switch (((c = [0, 0]), (u = [0, 0]), r)) {
            ...
            case 9:
                (u = m((u = h(u, [0, e.charCodeAt(t + 8)])), s)), (a = h(a, (u = m((u = f(u, 33)), l))));
            case 8:
            ...
            case 1:
                (c = m((c = h(c, [0, e.charCodeAt(t)])), l)), (i = h(i, (c = m((c = f(c, 31)), s))));
        }
        return (
            ...
            function () {
                return t(e, void 0, void 0, function () {
                    ...
                    return r(this, function (n) {
                        switch (n.label) {
                            case 0:
                                return B((e = T())) ? (N ? [2, o(N)] : M() ? [4, ((t = document), (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))] : [3, 2]) : [3, 2];
                            case 1:
    ...
    function E(e) {
        ...
        return t(this, void 0, void 0, function () {
            ...
            return r(this, function (r) {
                switch (r.label) {
                    case 0:
                        for (t = document, o = t.createElement("div"), i = new Array(e.length), c = {}, O(o), s = 0; s < e.length; ++s) (u = I(e[s])), O((l = t.createElement("div"))), l.appendChild(u), o.appendChild(l), (i[s] = u);
                        r.label = 1;
                    case 1:
    ...
    var te = {
        fonts: function () {
            return j(function (e, n) {
                ...
                r.appendChild(o);
                for (var s = 0; s < J.length; s++) (i[J[s]] = u[s].offsetWidth), (a[J[s]] = u[s].offsetHeight);
            ...
            return (function (e, n) {
                ...
                return j(function (t, r) {
                    var i = r.document,
                        a = i.body,
                        c = a.style;
                    (c.width = n + "px"), (c.webkitTextSizeAdjust = c.textSizeAdjust = "none"), F() ? (a.style.zoom = "" + 1 / r.devicePixelRatio) : Y() && (a.style.zoom = "reset");
                ...
                for (var t = {}, r = {}, o = 0, i = Object.keys(ne); o < i.length; o++) {
                    var a = i[o],
                        c = ne[a],
                        u = c[0],
                        l = void 0 === u ? {} : u,
        ...
        languages: function () {
            ...
            if ((void 0 !== r && t.push([r]), Array.isArray(n.languages)))
                (F() && L([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3) || t.push(n.languages);
